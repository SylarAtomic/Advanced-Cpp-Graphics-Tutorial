...
namespace Bengine {
	...
	void GLSLProgram::compilerShaders(const std::string& vertexShaderFilePath, const std::string& fragmentShaderFilepath)
	{
	...
	void GLSLProgram::compileShader(const std::string& filePath, GLuint id)
	{
		...
		if (success == GL_FALSE)
		{
			...
			std::printf("%s \n", &(errorLog[0]));
			fatalError("Shader " + filePath + " fail to compile");
